...
from . import Filler
from ..nn.models import MPGRUNet, GRINet, BiMPGRUNet, DGRINet, DGLANet
...
class GraphFiller(Filler):
    ...
    def __init__(self,
        ...
        elif model_class in [GRINet, BiMPGRUNet, DGRINet, DGLANet]:
    ...
    def training_step(self, batch, batch_idx):
        ...
        # observe batch data
        observation = torch.mul(batch_data['x'], batch_preprocessing['scale'][0]) + batch_preprocessing['bias'][0]
        ...
        imputation, predictions = (res[0], res[1:-1]) if isinstance(res, (list, tuple)) else (res, [])
        adj_dis = res[-1]
        ...
        # Change the loss same as trainmae
        # self.scaled_target = False
        # self.tradeoff = 0.1
