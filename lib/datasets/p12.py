...
class P12(PandasDataset):
    def __init__(self, impute_nans=False, freq='1S', masked_sensors=None):
        ...
        self.dist = dist
        super().__init__(dataframe=df, u=None, mask=mask, name='P12', freq=freq, aggr='nearest')


    def load_raw(self):
        path = os.path.join(datasets_path['P12'], 'P12.npz')
        eval_mask = None
...
class MissingP12(P12):

    def __init__(self, missing_ratio=0.8, seed=1):
        super(P12, self).__init__()
