...
class P19(PandasDataset):
    def __init__(self, impute_nans=False, freq='1S', masked_sensors=None):
        ...
        self.dist = dist
        super().__init__(dataframe=df, u=None, mask=mask, name='P19', freq=freq, aggr='nearest')


    def load_raw(self):
        path = os.path.join(datasets_path['P19'], 'P19.npz')
        eval_mask = None
...
class MissingP19(P19):

    def __init__(self, missing_ratio=0.8, seed=1):
        super(P19, self).__init__()
