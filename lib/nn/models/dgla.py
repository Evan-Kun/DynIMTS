...
class DGLANet(nn.Module):
    def __init__(self,
        ...
        self.dgla = EncoderDecoder(input_size=self.d_in,
                                   ff_size=d_ff,
    ...
    def forward(self, x, mask=None, u=None, **kwargs):
        ...
        imputation, prediction = self.dgla(x, self.adj, mask=mask, u=u, cached_support=self.training)
