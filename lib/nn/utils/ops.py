...
def binary_cross_entropy(y_predict, y, reduction='none'):
    return F.binary_cross_entropy(y_predict, y, reduction=reduction)


def binary_logits_cross_entropy(y_predict, y, reduction='none'):
    return F.binary_cross_entropy_with_logits(y_predict, y, reduction=reduction)
